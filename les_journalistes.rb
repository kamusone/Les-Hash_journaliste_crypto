...
puts "il y a #{array_handle.length} handle "
puts "*"*50
...
puts"il y a #{compteur} de handle avec chiffre "
puts "*"*50
...
puts "il y a #{compteur} de handle en majuscule "
puts "*"*50
...
puts "il y a #{compteur} fois de mot qui contiennet une majuscule"
puts "*"*50
...
puts "il y a #{compteur} fois de mot qui contiennent un '_'"
puts "*"*50
#Trie la liste de handle par ordre alphabétique (problematique d'ordre table scii )
